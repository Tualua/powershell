...
{
  $PowershellThread = [powershell]::Create().AddCommand('Get-MinerDataAll')
...
$MinersInfoTable|Sort-Object -Property Customer,WOrker|Format-Table -Property Customer,Worker,Hostname,Threads,LocalHashrate,LocalStatus,PoolHashrate,PoolStatus
{0:mm:ss} -f $EndTime